...
function Header() {
  ...
  const navigationItems = [
    ...
    { label: "INVESTIGACIÓN", href: "/publicaciones", hasDropdown: true, dropdownItems: [{ label: "PUBLICACIONES OFICIALES", href: "#section-publicaciones__oficiales" }, { label: "TRABAJOS HISTÓRICOS", href: "#section-trabajos__historicos" }, { label: "GACETA ACADÉMICA", href: "#section-gaceta__academica" }, { label: "OTROS DOCUMENTOS", href: "#section-otros__documentos" }] },
    { label: "BIBLIOTECA", href: "/biblioteca", hasDropdown: true },
